...
#SBATCH -c 64
#SBATCH -o logs/latest_p5_analyze.log
...
RESULT="results/p5_analyze.csv"

PUBS_ROOT="data/pubs"
TMP_LOG="logs/tmp5.log"
...
for dataset_type in "${DATASET_TYPES[@]}"; do
    for size in "${SIZES[@]}"; do
        ...
        apptainer exec \
            ...
            --nv \
            $container \
            bash -c "src/assignment7_problem5.py --dataset $DATASET --queries $QUERIES --labels $LABELS --batch-size $BATCH_SIZE;" > $TMP_LOG
